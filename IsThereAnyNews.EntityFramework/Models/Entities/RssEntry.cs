...
namespace IsThereAnyNews.EntityFramework.Models.Entities
{
    ...
    {
        public RssEntry() : this(string.Empty, DateTimeOffset.MinValue, string.Empty, string.Empty, 0, string.Empty)
        {

        }

        public RssEntry(string id, DateTimeOffset publishDate, string title, string text, long channelId, string url)
        {
            this.RssId = id;
